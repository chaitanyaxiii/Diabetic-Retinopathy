...
?>
  ...
  <head>
    ...
    <title>Disease Prediction System ||Admin Dashboard </title>
    ...
    <style>
      ...
      .flex-p .content-p {
        ...
        padding: 21px;
        justify-content: center;
        margin-left: 200px; /* Adjust margin to ensure images are not hidden behind the sidebar */
      }

      .image-grid {
        display: grid;
        grid-template-columns: repeat(2, 1fr); /* Two images per row */
        gap: 15px; /* Increased padding between images */
        justify-content: center;
      }
      ...
      .image-grid img {
        ...
        border-radius: 10px; /* Ensure border radius on images */
        margin-right: -100px;
      }
      ...
      .image-grid .image-description {
        ...
        text-align: center;
        padding: 5px 0;
        border-radius: 0 0 10px 10px; /* Rounded corners for description */
      }
            ...
            <div class="content-p">
              <div class="image-grid">
                <div class="image-item" >
                  ...
                  <a href="FocalBulg.php"><div class="image-description">Focal Bulg</div></a>
                </div>
                <div class="image-item">
                  <img src="FusiForm.jpeg" alt="Fusi Form">
                  <a href="Fusi-Form.php"><div class="image-description">Fusi Form</div></a>
                </div>
                <div class="image-item">
                ...
                <div class="image-item">
                  ...
                  <div class="image-description">Pendunculated</div>
                </div>
                <div class="image-item">
                  <img src="Saccaric.jpeg" alt="Saccaric">
                  <div class="image-description">Saccular Fusi Form</div>
                </div>
                <div class="image-item">
                  <img src="Scaccular.jpeg" alt="Scaccular">
                  <div class="image-description">Saccular</div>
                </div>
              </div>
            </div>
            <div class="clear"></div>
